...
setwd("/workspaces/Wind-Energy-Yield-Forecast/R")

# 1.1. Used Libraries:

my_packages <- c("httpgd",
...
![Source: Google Earth](../images/wt_location.png){width="100%"}
...
![GW 165-6.0 6300](../images/Goldwind_GW165-60.jpg){width="35%"}
